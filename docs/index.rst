.. pyParticleEst documentation master file, created by
   sphinx-quickstart on Wed Oct  8 13:24:07 2014.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to pyParticleEst's documentation!
=========================================
...
At the moment the main source of documentation are docstrings in the code
combined the examples and testcases which are found under the test/ directory
...
Again, you are encourage to study the examples under pyparticleest/test/
to see how the framework can be used.

A good starting point is
        pyparticleest/test/filtering/basic_model.py

followed by
        pyparticleest/test/filtering/nonlin_model.py

For an example of a simple MLNLG model see
        pyparticleest/test/smoothing/mlnlg_model.py

and for the commonly used "standard nonlinear model" see
        pyparticleest/test/smoothing/standard_nonlin_model.py
...
Documentation:
https://readthedocs.org/projects/pyparticleest
